...
@emails.route("/confirm_change_password", methods=["GET"])
...
@emails.route("/send_email_delete_account", methods=["GET"])
...
@emails.route("/confirm_delete_account", methods=["GET"])
...
@emails.route("/send_email_reset_password", methods=["GET"])
